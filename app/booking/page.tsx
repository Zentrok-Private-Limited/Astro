...
const handleChange = (
  ...
  <div className="mx-auto max-w-7xl px-6 py-14">
    ...
    <p className="mt-5 max-w-3xl text-lg leading-8 text-muted-foreground">
      Share your spiritual requirements and let our experienced Vedic priests
      perform an authentic puja dedicated to your prayers and intentions.
      Complete the booking form below to begin your spiritual journey.
    </p>
...
<section className="py-10">
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mb-10">
      ...
      <p className="mt-3 max-w-3xl text-muted-foreground">
        Please provide your details so our priests can perform a personalized
        sankalp during the ritual.
      </p>
    </div>
...
<section className="py-10">
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mb-10">
      ...
      <p className="mt-3 max-w-3xl text-muted-foreground">
        Provide the ritual details so our priests can prepare your personalized
        sankalp and perform the pooja according to Vedic traditions.
      </p>
    </div>
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mb-10 text-center">
      ...
      <p className="mt-3 text-muted-foreground">
        Please review your booking details before proceeding with the confirmation deposit.
      </p>
    </div>
      ...
      <div className="lg:sticky lg:top-24 h-fit">
        ...
        <div className="rounded-3xl border border-primary/20 bg-primary p-8 text-primary-foreground shadow-xl">
          ...
          <p className="mt-4 leading-7 text-primary-foreground/90">
            To reserve your preferred date and begin the arrangements for your
            personalized pooja, a confirmation deposit is required.
          </p>
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mb-12 text-center">
      ...
      <p className="mx-auto mt-4 max-w-3xl leading-8 text-muted-foreground">
        ...
        understand your concerns and recommend the most suitable Vedic ritual
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-muted-foreground">
                Guidance from experienced Vedic priests and spiritual experts.
              </p>
            </div>
          </div>
